...
func (insprEnv *InsprEnvironmentVariables) IsInInputChannel(word string, separator string) bool {
...
func (insprEnv *InsprEnvironmentVariables) IsInOutputChannel(word string, separator string) bool {
