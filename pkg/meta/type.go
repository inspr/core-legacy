...
// Type is a struct that can be a reference to an outsourced type or can be a local type,
// one of it's uses is the definition of the content type that is going to be sent in a channel or route.
//
