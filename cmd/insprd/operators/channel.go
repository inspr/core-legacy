...
func (co *ChannelOperator) Get(ctx context.Context, context string, name string) (*meta.Channel, error) {
	return &meta.Channel{}, nil
}

// GetAll - returns all channels in the given context
func (co *ChannelOperator) GetAll(ctx context.Context, context string) ([]*meta.Channel, error) {
	return []*meta.Channel{{}, {}}, nil
}
...
func (co *ChannelOperator) Create(ctx context.Context, context string, channel *meta.Channel) error {
	return nil
}
...
func (co *ChannelOperator) Update(ctx context.Context, context string, channel *meta.Channel) error {
	return nil
}

// Delete - deletes the channel in the context given and with the name specified
func (co *ChannelOperator) Delete(ctx context.Context, context string, name string) error {
	return nil
}
