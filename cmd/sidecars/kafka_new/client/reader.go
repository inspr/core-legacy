...
*/
func (reader *Reader) ReadMessage(ctx context.Context, channel string) (models.BrokerMessage, error) {
		...
		default:
			...
			case kafka.Error:
				if ev.Code() == kafka.ErrAllBrokersDown {
					return models.BrokerMessage{}, ierrors.
						NewError().
						InnerError(ev).
				...
				return models.BrokerMessage{}, ierrors.NewError().
					Message("%v", ev).
					Build()
